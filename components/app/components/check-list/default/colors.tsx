  ...
  public render() {
    return (
      <ExampleContainer title='Colors' shouldRender={true}>
        ...
        <Block direction='row'>
          <CheckList color="secondary" value={this.state.secondary} onValueChange={this.handleSecondaryChange}>
            <Check value='secondary' label='secondary' />
            <Check value='secondary1' label='secondary' />
            <Check value='secondary2' label='secondary' />
          </CheckList>

          <CheckList color="light" value={this.state.light} onValueChange={this.handelLightChange}>
