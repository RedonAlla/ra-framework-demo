...
export default class extends React.Component<{}, StateType> {
  ...
  public handleValueNumberChange(selectedItems: Array<number>) {
    this.setState({valueNumber: selectedItems});
  }
  ...
  public render() {
    return (
      <ExampleContainer title='Value' shouldRender={true}>
        <Block direction='row'>
          <CheckList material label='Object Value' valueField={'id'} value={this.state.valueObject} onValueChange={this.handleValueObjectChange}>
        ...
        <Block direction='row'>
          <CheckList material label='string' value={this.state.valueString} onValueChange={this.handleValueStringChange}>
        ...
        <Block direction='row'>
          <CheckList material label='number' value={this.state.valueNumber} onValueChange={this.handleValueNumberChange}>
