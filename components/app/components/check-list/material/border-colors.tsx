  ...
  public render() {
    return (
      <ExampleContainer title='Border Color' shouldRender={true}>
        ...
        <Block direction='row'>
          <CheckList borderColor="crimson" label='crimson' material value={this.state.nameValues} onValueChange={this.handleNameValueChange}>
            <Check value='crimson' label='crimson' />
            <Check value='blue' label='blue' />
            <Check value='red' label='red' />
          </CheckList>

          <CheckList borderColor="rgb(237, 20, 61)" label='rgb(237, 20, 61)' material value={this.state.rgbValues} onValueChange={this.handleRgbValueChange}>
        ...
        <Block direction='row'>
          <CheckList borderColor="#ed143d" label='#ed143d' material value={this.state.hexValues} onValueChange={this.handleHexValueChange}>
            <Check value='#ed143d' label='#ed143d' />
            <Check value='#ce04d1' label='#ce04d1' />
            <Check value='#343deb' label='#343deb' />
          </CheckList>

          <CheckList borderColor="rgba(237, 20, 61, 0.5)"label='rgba(237, 20, 61, 0.5)' material value={this.state.rgbaValues} onValueChange={this.handleRgbaValueChange}>
