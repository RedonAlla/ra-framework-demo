...
export default class extends React.Component<{}, StateProp> {
  ...
  public render() {
    return (
      <ExampleContainer title='Size' shouldRender={true}>
        
        <Block direction='row'>
          <CheckList material label='default' size="default" value={this.state.default} onValueChange={this.handleDefaultChange}>
            <Check value='default' label='default' />
            <Check value='default1' label='default' />
            <Check value='default2' label='default' />
          </CheckList>

          <CheckList material label='small' size="small" value={this.state.small} onValueChange={this.handleSmallChange}>
        ...
        <Block direction='row'>
          <CheckList material label='medium' size="medium" value={this.state.medium} onValueChange={this.handleMediumChange}>
            <Check value='medium' label='medium' />
            <Check value='medium1' label='medium' />
            <Check value='medium2' label='medium' />
          </CheckList>

          <CheckList material label='large' size="large" value={this.state.large} onValueChange={this.handelLargeChange}>
