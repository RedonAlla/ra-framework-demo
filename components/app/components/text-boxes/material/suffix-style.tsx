      ...
      <DemoBlock title='Suffix style'>
        <View style={styles.row}>
          <View style={styles.column}>
            <TextBox material label='Suffix style' placeholder='Style with StyleProp<TextStyle>' suffix="star" suffixStyle={styles.suffix} />
          </View>
          <View style={styles.column}>
            <TextBox material label='Suffix style' placeholder='Style with function' suffix="star" suffixStyle={suffixStyle('rgb(35, 189, 224)', 'crimson')} />
          </View>
        </View>
      </DemoBlock>
    );
