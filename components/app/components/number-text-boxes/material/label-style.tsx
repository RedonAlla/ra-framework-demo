      ...
      <DemoBlock title='Label style'>
        <View style={styles.row}>
          <View style={styles.column}>
            <NumberTextBox material label='Label style' placeholder='Style with StyleProp<TextStyle>' labelStyle={styles.label} />
          </View>
          <View style={styles.column}>
            <NumberTextBox material label='Label style' placeholder='Style with function' labelStyle={labelStyles('rgb(35, 189, 224)', 'crimson')} />
          </View>
        </View>
      </DemoBlock>
    );
