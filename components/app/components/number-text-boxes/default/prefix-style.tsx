      ...
      <DemoBlock title='Prefix style'>
        <View style={styles.row}>
          <View style={styles.column}>
            <NumberTextBox placeholder='Style with StyleProp<TextStyle>' prefix="star" prefixStyle={styles.prefix} />
          </View>
          <View style={styles.column}>
            <NumberTextBox placeholder='Style with function' prefix="star" prefixStyle={prefixStyle('rgb(35, 189, 224)', 'crimson')} />
          </View>
        </View>
      </DemoBlock>
    );
